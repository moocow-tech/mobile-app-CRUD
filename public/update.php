...
<tr>
  ...
  <?php foreach ($result as $row) { ?>
	...
	<td> <a href="update-single.php?id=<?php echo escape($row["id"]); ?>" data-role="button" class="ui-shadow ui-btn"  data-transition="slidedown" name="back" value="Edit" data-theme="b" data-ajax="false">Edit</a>
</td>
      </tr>
    <?php } ?>
      </tbody>
